...
s.onload = function (e) {
    ...
    $('#kw-promo-div').append(
        ...
        '</a>' +
        '<iframe id="ex1" class="modal kw-promo-modal" style="max-width:90%;"src="https://ilyaail.github.io/Adgoup/index.html"></iframe>' +
        '</div>'
    );
    ...
    $('.kw-iframe-wrapper .overlay').hover(function (e) {
        ...
        myInterval = setInterval(function () {
            --counter;
            var loader_img = '<img src="https://ilyaail.github.io/Adgoup/img/up_logo_f_color.gif" alt="">';
            $('.kw-counter').text('');
            if (counter > 0) {
